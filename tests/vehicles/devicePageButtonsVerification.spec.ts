...
test.describe('Device Page Buttons Verification', () => {
    ...
    test('SOT-6909 | should verify button CAMERA RULES for devices @regression', async () => {        
    ...
    test('SOT-6910 | should verify button Data Usage for devices @regression', async () => {
    ...
    test('SOT-6911 | should verify button Unpair Camera for devices @regression', async () => {
    ...
    test('SOT-6912 | should verify button Live Stream for devices @regression', async () => {        
